...
export default function VehicleMakes() {
  ...
  useEffect(() =>{
    ...
    console.log("working");
       Axios.post("https://carpages-canada-mongodb.onrender.com/categories/insertmake",{
         makename:makeName
       }).then((response)=>{
     ...
     const updateMake = () =>{
      ...
      console.log("working");
         Axios.post("https://carpages-canada-mongodb.onrender.com/categories/updatetmake",{
     ...
     const deleteMake = () =>{
      ...
      console.log("working");
         Axios.post("https://carpages-canada-mongodb.onrender.com/categories/deletemake",{
          makeId:updateMakes
         }).then((response)=>{
            ...
            <div className='veh-opr-reslt-makes-add' >
                ...
                <div className='veh-opr-reslt-makes-add'> 
                   <div className='add-cat-container'  >
                    ...
                    <option value="" selected>Choose Makes</option>
                      {fetchMakes.map((val)=>{
                         return (<option value={val._id}  >{val.makes_name}</option>)
                          })}                
                    </select>
                    </div>
              ...
              {showAddMakes==="deletevehiclemakes" ? 
                ...
                {showAddMakes==="viewvehiclemakes" ? <div className='veh-opr-reslt-makes-add' >
                  ...
                  <option value="" selected>Choose Makes</option>
                   {fetchMakes.map((val)=>{return (<option value={val.makes_name}  >{val.makes_name}</option>)})}
                    </select>
                    </div>
