...
export default function MainVehicleSearch() {
  ...
  useEffect(() => {
    ...
    Axios.get("http://localhost:3010/categories/getprices").then((res)=>{
      setprice(res.data);
      ...
      Axios.get("http://localhost:3010/categories/makes").then((res1)=>{
        ...
        Axios.get("http://localhost:3010/categories/popularcities").then((res2)=>{
  ...
  const showcities=()=>{
    Axios.get("http://localhost:3010/categories/onlycities").then((res2)=>{
      setCities(res2.data);
      console.log(res2.data);
  })
  };
